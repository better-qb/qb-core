...
---@param userId number
---@return table?
function QBCore.Functions.GetPlayerByUserId(userId)
    for src in pairs(QBCore.Players) do
        if QBCore.Players[src].PlayerData.userId == userId then
            return QBCore.Players[src]
        end
    end
    return nil
...
---Get offline player by user id
---@param userId number
---@return table?
function QBCore.Functions.GetOfflinePlayerByUserId(userId)
    return QBCore.Player.GetOfflinePlayer(userId)
end
...
function QBCore.Functions.HasPermission(source, permission)
    ...
    return player.PlayerData.staff.level >= permission
end
...
---@param permission number
---@return boolean
function QBCore.Functions.HasPermissionUserId(userId, permission)
    local player = QBCore.Functions.GetPlayerByUserId(userId)
    if not player then return 0 end
...
function QBCore.Functions.GetPermission(source)
    local src = source
    return QBCore.Functions.GetPlayer(source).PlayerData.staff.level
end

---Get the players permissions
---@param userId any
---@return table
function QBCore.Functions.GetPermissionByUserId(userId)
    local player = QBCore.Functions.GetPlayerByUserId(userId)
    if not player then return 0 end
    return player.PlayerData.staff.level
end
